...
public final class Settings {
    ...
    public static int PROJECTION_MAX_PORTALS_PER_OBSERVER_TICK = 4;
    public static int PROJECTION_INTEREST_GRACE_TICKS = 5;
