...
public enum MSound
{
	...
	FRAME_FILL("FIREWORK_BLAST", "BLOCK_END_PORTAL_FRAME_FILL"),
	FRAME_SPAWN("FIREWORK_BLAST", "BLOCK_END_PORTAL_SPAWN"),
	EYE_LAUNCH("FIREWORK_BLAST", "ENTITY_ENDEREYE_LAUNCH"),
	EYE_DEATH("FIREWORK_BLAST", "ENTITY_ENDEREYE_DEATH"),
	BLOCK_CHORUS_FLOWER_DEATH("FIREWORK_BLAST", "BLOCK_CHORUS_FLOWER_DEATH"),
	BLOCK_CHORUS_FLOWER_GROW("FIREWORK_BLAST", "BLOCK_CHORUS_FLOWER_GROW"),
	ECHEST_CLOSE("CHEST_CLOSE", "BLOCK_ENDERCHEST_CLOSE"),
	ECHEST_OPEN("CHEST_OPEN", "BLOCK_ENDERCHEST_OPEN"),
	...
	public Sound bukkitSound()
	{
		...
		Sound modern = lookup(post19sound);
		if(modern != null)
		{
			return resolvedSound = modern;
		}
		Sound legacy = lookup(pre19sound);
		return resolvedSound = legacy;
	}

	private static Sound lookup(String name)
	{
		...
		Sound byKey = Registry.SOUNDS.get(NamespacedKey.minecraft(key));
		if(byKey != null)
		{
			return byKey;
		}
		String fallback = name.toLowerCase();
		return Registry.SOUNDS.get(NamespacedKey.minecraft(fallback));
	}
}